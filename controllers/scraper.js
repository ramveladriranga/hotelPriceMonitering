...
async function saveToExcel(hotelName, city, myPrice, competitorPrice, checkInDate, checkOutDate, adults, alert) {
    try {
        ...
        if (!fs.existsSync(excelDir)) {
            ...
            console.log(`Excel directory created: ${excelDir}`);
        }

        // Initialize sheet only once (outside the loop)
        let sheet;
        try {
            ...
            // If file doesn't exist, create new one with headers
        ...
        console.log("Added row to Excel sheet.");
